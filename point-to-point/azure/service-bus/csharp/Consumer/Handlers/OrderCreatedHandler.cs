...
public class OrderCreatedHandler : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation("Starting Service Bus queue processor for {Queue}", _settings.QueueName);
        ...
        {
            _logger.LogInformation("Service Bus queue processor cancellation requested.");
        }
    }
    ...
    private async Task HandleMessageAsync(ProcessMessageEventArgs args)
    {
        try
        {
            ...
            _logger.LogInformation(
                "Received queue message {MessageId}: {Content} (sent at {Timestamp})",
        ...
        {
            _logger.LogError(ex, "Error processing Service Bus queue message");
    ...
    {
        _logger.LogError(args.Exception, "Service Bus queue processor error");
